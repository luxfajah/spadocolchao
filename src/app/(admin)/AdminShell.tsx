...
export function AdminShell({ children, user, access, hideNavigation = false }: AdminShellProps) {
  ...
  return (
    <div className="flex min-h-screen bg-background relative">
      ...
      <div className="hidden lg:flex flex-1 justify-center items-start gap-8 pt-0 px-8">
        <div className="w-72 shrink-0 relative">
          <Sidebar
            className="fixed left-auto"
            allowedAreas={access.allowedAreas}
            homeHref={access.homeHref}
          />
        </div>

        <div className="flex-1 flex flex-col max-w-[1500px] min-w-0 pb-20 lg:pb-0">
